...
jimmyShelf7 = Shelf.create(name: 'Shopping', user_id: user1.id)
jimmyShelf8 = Shelf.create(name: 'Travel', user_id: user1.id)
jimmyShelf9 = Shelf.create(name: 'Blogs', user_id: user1.id)
jimmyShelf10 = Shelf.create(name: 'videos', user_id: user1.id)
jimmyShelf11 = Shelf.create(name: 'RealEstate', user_id: user1.id)
...
jimmyBookmark1 = Bookmark.create(name: 'Facebook', url: 'www.facebook.com', description: 'Social media app', color: 'Blue', shelf_id: jimmyShelf1.id)
jimmyBookmark2 = Bookmark.create(name: 'Google', url: 'www.google.com', description: 'search engine', color: 'Orange', shelf_id: jimmyShelf1.id)
...
jimmyBookmark4 = Bookmark.create(name: 'Youtube', url: 'www.youtube.com', description: 'music app', color: 'Yellow', shelf_id: jimmyShelf1.id)
jimmyBookmark5 = Bookmark.create(name: 'Hudson Bay', url: 'www.thebay.com', description: 'shopping', color: 'Pink', shelf_id: jimmyShelf1.id)
...
jimmyBookmark7 = Bookmark.create(name: 'Coffee Break Arcade', url: 'https://www.coffeebreakarcade.com/', description: 'shopping', color: 'Pink', shelf_id: jimmyShelf2.id)

#Jimmy's Bookmarks news shelf
jimmyBookmark8 = Bookmark.create(name: 'CBC News', url: 'https://www.cbc.ca/news', description: 'shopping', color: 'Pink', shelf_id: jimmyShelf3.id)
jimmyBookmark8 = Bookmark.create(name: 'Guelph News', url: 'https://www.guelphtoday.com/', description: 'shopping', color: 'Pink', shelf_id: jimmyShelf3.id)
