...
jimmyShelf6 = Shelf.create(name: 'Articles', user_id: user1.id)
...
jimmyBookmark3 = Bookmark.create(name: 'Lighthouse Labs', url: 'https://www.lighthouselabs.ca', description: 'Education', color: 'Green', shelf_id: jimmyShelf1.id)
...
jimmyBookmark14 = Bookmark.create(name: 'Halton News', url: 'https://www.insidehalton.com/milton-on/', description: 'news', color: 'Blue', shelf_id: jimmyShelf3.id)
jimmyBookmark15 = Bookmark.create(name: 'Milton Weather', url: 'https://www.theweathernetwork.com/ca/hourly-weather-forecast/ontario/milton', description: 'news', color: 'Yellow', shelf_id: jimmyShelf3.id)
...
jimmyBookmark12 = Bookmark.create(name: 'wikipedia-Coding', url: 'https://en.wikipedia.org/wiki/Coding', description: 'articles', color: 'pink', shelf_id: jimmyShelf6.id) 
jimmyBookmark13 = Bookmark.create(name: 'wikipedia-React', url: 'https://en.wikipedia.org/wiki/React', description: 'articles', color: 'pink', shelf_id: jimmyShelf6.id) 
jimmyBookmark14 = Bookmark.create(name: 'wikipedia-Javascripts', url: 'https://en.wikipedia.org/wiki/JavaScript', description: 'articles', color: 'pink', shelf_id: jimmyShelf6.id) 
